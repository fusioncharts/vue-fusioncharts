...
const initSlots = (instance, children, optimized) => {
  ...
  if (instance.vnode.shapeFlag & 32) {
    ...
    if (cacheIndexes) (0,shared_esm_bundler.def)(slots, "__", cacheIndexes, true);
...
{}
    ...
    if (parent && (0,shared_esm_bundler.isArray)(slotCacheKeys)) {
...
{}
  ...
  onMounted(() => {
    runtime_core_esm_bundler_watch(setVars, shared_esm_bundler.NOOP, { flush: "post" });
...
var optionsMap = exports.optionsMap = {
  type: 'type',
  id: 'id',
  width: 'width',
  height: 'height',
